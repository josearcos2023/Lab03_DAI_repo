            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        <a href="Ejercicio01.php" class="nav-item nav-link disabled">Ejercicio #1</a>
            ...
            <div class="row">
                <div class="col-12 mt-2">
                    <div class="card text-bg-success">
                        <h5 class="card-header">Ejercicio #1</h5>
                        <div class="card-body">
                            <form action="Ejercicio01.php" method="post">
                                <div class="form-group">
                                    <div>
                                        <label for="num1">Username</label><br>
                                        <input type="text" id="user" name="user" placeholder="Enter the username" required><br>
